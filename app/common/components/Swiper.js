/* eslint-disable */
// disable lint because external file
/**
 * react-native-swiper
...
export default class Swiper extends Component {
	...
	componentDidUpdate(prevProps) {
		...
		this.setState(
			this.initState(this.props, this.props.index !== prevProps.index)
		);
	}
	...
	initState(props, updateIndex = false) {
		...
		initState.height = props._height || height;
		...
		if (total > 1) {
			...
			pages = pages.map((page, i) => {
				if (loadMinimal) {
					...
					return (
						<View key={i} style={pageStyleLoading}>
